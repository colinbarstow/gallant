<nav class="navbar clearHeader">
    <div class="container-fluid">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="{{ url('/') }}">{{ config('app.name') }}</a> </div>
                ...
                <ul class="dropdown-menu">
                    <li class="body">
                        <ul class="menu">
                            <li>
                                <ul>
                                    <li><a href="{{ url('/adminarea/quotes') }}"><i class="zmdi zmdi-email"></i><span>Quotes</span></a></li>
                                    <li><a href="{{ url('/adminarea/enquiries') }}"><i class="zmdi zmdi-accounts-list"></i><span>Enquiries</span></a></li>
                                    <li><a href="{{ url('/adminarea/blogposts') }}"><i class="zmdi zmdi-comment-text"></i><span>Blog</span></a></li>
                                    <li><a href="{{ url('/adminarea/projects') }}"><i class="zmdi zmdi-arrows"></i><span>Projects</span></a></li>
                                    <li><a href="{{ url('/adminarea/testimonials') }}"><i class="zmdi zmdi-view-column"></i><span>Testimonials</span></a></li>
                                    <li><a href="{{ url('/') }}" target="_blank"><i class="zmdi zmdi-calendar-note"></i><span>Website</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="body">
                        <ul class="menu">
                            <li> <a href="javascript:void(0);">
                                    <div class="icon-circle"> <img src="{{ asset('admin/images/avatar1.jpg') }}" alt=""> </div>
                                    <div class="menu-info">
                                        <h4>David Belle</h4>
                            ...
                            <li> <a href="javascript:void(0);">
                                    <div class="icon-circle"> <img src="{{ asset('admin/images/avatar2.jpg') }}" alt=""> </div>
                                    <div class="menu-info">
                                        <h4>David Belle</h4>
                                        <p class="ellipsis">Cum sociis natoque penatibus et magnis dis parturient montes</p>
                                    </div>
                            ...
                            <li> <a href="javascript:void(0);">
                                    <div class="icon-circle"> <img src="{{ asset('admin/images/avatar3.jpg') }}" alt=""> </div>
                                    <div class="menu-info">
                                        <h4>David Belle</h4>
                                        <p class="ellipsis">Cum sociis natoque penatibus et magnis dis parturient montes</p>
                                    </div>
                            ...
                            <li> <a href="javascript:void(0);">
                                    <div class="icon-circle"> <img src="{{ asset('admin/images/avatar4.jpg') }}" alt=""> </div>
                                    <div class="menu-info">
                                        <h4>David Belle</h4>
                                        <p class="ellipsis">Cum sociis natoque penatibus et magnis dis parturient montes</p>
                                    </div>
