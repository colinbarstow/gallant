                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <form action="/deleteblogpost" method="POST" class="body" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-lg">
                                            <div class="form-line">
                                                ...
                                                <a href="/adminarea/blogposts" type="submit" style="color:#fff" class="btn btn-success">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
