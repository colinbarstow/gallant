                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <form action="/addservice" method="POST" class="body" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea name="short_description" rows="1" class="form-control no-resize auto-growth" placeholder="Please a short description"></textarea>
                                    </div>
                                </div>
