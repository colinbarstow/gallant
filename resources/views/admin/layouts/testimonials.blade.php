                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    ...
                                    <td><img src="/frontend/images/testimonials/{{ $testimonial->image }}" width="100px"></td>
                                    <td><a href="/adminarea/edittestimonial/{{ $testimonial->id }}"><i class="fa fa-2x fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="/adminarea/deletetestimonial/{{ $testimonial->id }}" class="btn btn-danger" style="color:#fff">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
