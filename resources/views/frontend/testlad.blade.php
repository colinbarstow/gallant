...
<head>
    ...
    <title>Definity - Portfolio Single 1</title>
                    ...
                    <ul class="dropdown-menu">
                        <div class="row">
                            ...
                            <div class="col-lg-3 mb-sm-30">
                                ...
                                <li role="separator" class="divider"></li>
                                <li><a href="portfolio-fw-1col.html">Full Width 1 Column</a></li>
                                <li><a href="portfolio-fw-2col.html">Full Width 2 Columns</a></li>
                                <li><a href="portfolio-fw-3col.html">Full Width 3 Columns</a></li>
                                <li><a href="portfolio-fw-4col.html">Full Width 4 Columns</a></li>
                            </div>
                            ...
                            <div class="col-lg-3 mb-sm-30">
                                ...
                                <li role="separator" class="divider"></li>
                                <li><a href="portfolio-boxed-1col.html">Boxed 1 Columns</a></li>
                                <li><a href="portfolio-boxed-2col.html">Boxed 2 Columns</a></li>
                                <li><a href="portfolio-boxed-3col.html">Boxed 3 Columns</a></li>
                                <li><a href="portfolio-boxed-4col.html">Boxed 4 Columns</a></li>
                            </div>
                            ...
                            <div class="col-lg-3 mb-sm-30">
                                ...
                                <li role="separator" class="divider"></li>
                                <li><a href="portfolio-masonry-1.html">Masonry Layout 1</a></li>
                                <li><a href="portfolio-masonry-2.html">Masonry Layout 2</a></li>
                                <li><a href="portfolio-masonry-3.html">Masonry Layout 3</a></li>
                            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="single-img-slider">
                <li><img src="../../assets/images/project-single-img-1.jpg" alt="Project Image"></li>
                <li><img src="../../assets/images/project-single-img-2.jpg" alt="Project Image"></li>
            </ul>
        </div>
    </div><!-- / .row -->
            ...
            <div class="col-md-3 col-sm-6 mb-sm-100">
                <div class="widget gallery-widget">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="gallery-widget-lightbox"><img src="../../assets/images/insta-feed-1.jpg" alt="Instagram Image"><div class="hover-link"><span class="linea-arrows-plus"></span></div></a></li>

                        <li><a href="#" class="gallery-widget-lightbox"><img src="../../assets/images/insta-feed-2.jpg" alt="Instagram Image"><div class="hover-link"><span class="linea-arrows-plus"></span></div></a></li>

                        <li><a href="#" class="gallery-widget-lightbox"><img src="../../assets/images/insta-feed-3.jpg" alt="Instagram Image"><div class="hover-link"><span class="linea-arrows-plus"></span></div></a></li>

                        <li><a href="#" class="gallery-widget-lightbox"><img src="../../assets/images/insta-feed-4.jpg" alt="Instagram Image"><div class="hover-link"><span class="linea-arrows-plus"></span></div></a></li>

                        <li><a href="#" class="gallery-widget-lightbox"><img src="../../assets/images/insta-feed-5.jpg" alt="Instagram Image"><div class="hover-link"><span class="linea-arrows-plus"></span></div></a></li>

                        <li><a href="#" class="gallery-widget-lightbox"><img src="../../assets/images/insta-feed-6.jpg" alt="Instagram Image"><div class="hover-link"><span class="linea-arrows-plus"></span></div></a></li>
